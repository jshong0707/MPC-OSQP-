...
// char filename[] = "../Quadxml/scene.xml";
char filename[] = "../Quadxml/3D_Quad_SPINE.xml";
...
Trajectory Traj(K_FL, K_FR, K_RL, K_RR, B);

FSM FSM_(Traj);

MPC M(K_FL, K_FR, K_RL, K_RR, B, FSM_);

Controller C;

Integrate I(K_FL, K_FR, K_RL, K_RR, Traj, B, M, C, FSM_);
