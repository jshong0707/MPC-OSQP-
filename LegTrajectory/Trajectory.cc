...
Trajectory::Trajectory(F_Kinematics &K_FL, F_Kinematics &K_FR, F_Kinematics &K_RL, F_Kinematics &K_RR, Body &B_)
...
Vector3d Trajectory::get_foot_pos(int Leg_num)
{
    ...
    {
        case 0:
            return K_FL.get_pos(); break;
        case 1:
            return K_FR.get_pos(); break;
        case 2:
            return K_RL.get_pos(); break;
        case 3:
            return K_RR.get_pos(); break;
    }
